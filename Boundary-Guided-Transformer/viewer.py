...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_pic', type=str, default='/home/shenjj/GatedSCNN/data/leftImg8bit/test/23MRIMG00014.png',
    ...
    grad = cv2.Canny(cv2.imread( '/home/shenjj/GatedSCNN/data/gtFine/test_/23MRIMG00014.png'), 10, 100)
