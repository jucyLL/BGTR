        ...
        for data, target, grad, boundary, name in data_bar:
            ...
            if not is_train:
                ...
                for pred_tensor, pred_name in zip(prediction, name):
                    ...
                    print('path_name',pred_name)
                    #pred_name = pred_name.split('jpg')[0] + 'png'
                    #print('path_name',pred_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/home/shenjj/BGTR/data/', type=str, help='Data path for cityscapes dataset')
    ...
    parser.add_argument('--batch_size', default=2, type=int, help='Number of data for each batch to train')
    ...
    model = BGTR(backbone_type=backbone_type, num_classes=19).cuda()
    ...
    for epoch in range(1, epochs + 1):
        ...
        data_frame.to_csv('{}/{}_{}_{}_statistics.csv'.format(save_path, backbone_type, crop_h, crop_w),
                          index_label='epoch')
        print('val_mPAval_mPAval_mPAval_mPAval_mPAval_mPAval_mPAval_mPAval_mPAval_mPAval_mPAval_mPAval_mPA',val_mPA)
        print('best_mpaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',best_mpa)
        if val_mPA > best_mpa:
            best_mpa = val_mPA
            print('best_mpaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',best_mpa)
